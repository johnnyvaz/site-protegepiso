...
<div class="flex justify-center items-center bg-green-500 text-white py-8">
  <div class="text-center">
    ...
    <p class="text-lg"><strong><a href="https://api.whatsapp.com/send?phone=551639113911" target="_blank" class="text-white dark:text-blue-500">Entre em contato</a></strong> conosco e descubra uma grande oportunidade de negócio.</p>
  </div>
</div>
